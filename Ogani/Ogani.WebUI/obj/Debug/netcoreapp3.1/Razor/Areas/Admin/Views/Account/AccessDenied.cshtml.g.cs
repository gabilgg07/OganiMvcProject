#pragma checksum "/Volumes/MySSD/01.Codes/01.VS/01.LessonsCodes/OganiMvcProject/Ogani/Ogani.WebUI/Areas/Admin/Views/Account/AccessDenied.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6cef5440a09e2351815045d7aeb3ac7ade2d7a27"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6cef5440a09e2351815045d7aeb3ac7ade2d7a27", @"/Areas/Admin/Views/Account/AccessDenied.cshtml")]
...
");
            ...
            .ghost:before {
                ...
                visibility: hidden;
                opacity: 0;
                /* have each string of text introduced as the ghost returns from the right edge of the screen, and for the length of time it takes to cover the central portion (a fourth, which becomes an eight as the animation length is half the total d");
            WriteLiteral(@"uration) */
...
<svg style=""display: none"">
    ...
    <symbol id=""ghost""
            ...
            viewBox=""0 0 26.458333 26.458334"">
        <g transform=""translate(0 -270.542)"">
            <path d=""M4.63 279.293c0-4.833 3.85-8.751 8.6-8.751 4.748 0 8.598 3.918 8.598 8.75H13.23zM4.725 279.293h16.914c.052 0 .19.043.19.096l-.095 14.329c0 .026-.011.05-.028.068a.093.093 0 0 1-.067.028c-.881 0-1.235-1.68-2.114-1.616-.995.072-1.12 2.082-2.114 2.154-.88.064-1.233-1.615-2.115-1.615-.881 ");
            WriteLiteral(@"0-1.233 1.615-2.114 1.615-.881 0-1.233-1.615-2.114-1.615-.882 0-1.236 1.679-2.115 1.615-.994-.072-1.12-2.082-2.114-2.154-.88-.063-1.41 1.077-2.114 1.616-.021.016-.05-.01-.067-.028a.097.097 0 0 1-.028-.068v-14.33c0-.052.042-.095.095-.095z""
                  fill=""#f1eedb""
                  paint-order=""stroke fill markers"" />
...
<script>// target the elements in the DOM used in the project
    ...
    // for the length of the timo");
            WriteLiteral(@"ut, consider the --animation-duration custom property and add a small delay
    ...
    const timeoutID = setTimeout(() => {
        ...
        // introduce the key and keyhole svg elements ");
            WriteLiteral(@"by triggering the paused-by-default animation
